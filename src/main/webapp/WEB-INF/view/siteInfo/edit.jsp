							...
							<div class="am-u-sm-9 am-form-select">
								<select id="siteTemplate" name="siteTemplate"
									...
									<option value="default"
										<c:if test="${myfn:equals(entity.siteTemplate, 'default')}">selected="selected"</c:if>>样式一(公司)</option>
									<option value="news"
										<c:if test="${myfn:equals(entity.siteTemplate, 'news')}">selected="selected"</c:if>>样式二(新闻)</option>
									<option value="company"
										<c:if test="${myfn:equals(entity.siteTemplate, 'company')}">selected="selected"</c:if>>样式三(教育)</option>
								</select>
							</div>
						</div>
						<div class="am-form-group">
