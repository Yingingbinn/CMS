...
<body>
		...
		<div data-am-widget="slider" class="am-slider am-slider-default"
			...
			<ul class="am-slides">
				<c:forEach items="${slideImgs.items }" var="item">
					<li><img src='<c:url value="${item.imgUrl }"/>' height="500px"/></li>
				</c:forEach>
			</ul>
		</div>
	</div>
	...
	<div class="gray-li">
		<div class="customer-case part-all ">
			<div class="part-title">
				<a href="customer-case.html">  <span
  ...
  am-avg-md-4 am-avg-lg-4 am-gallery-bordered customer-case-content">
			...
			<div class="lan-bott">
				...
				<div class="right">
					<a href="customer-case.html"> <span class="see-more">查看更多</span>
					</a>
				</div>
				<div class="clear"></div>
			</div>
